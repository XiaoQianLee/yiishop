...
<div class="login w990 bc mt10 regist">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form action="<?php \yii\helpers\Url::to(['member/register'])?>" method="post" id="register">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" class="txt" name="tel" id="tel"/>
                    </li>
                    <li>
                        <label for="">验证码：</label>
                    ...
                    <li class="checkcode">
                        ...
                        <img id="img_captcha" src="<?=\yii\helpers\Url::to(['member/captcha'])?>" />
...
<script type="text/javascript">
    ...
    $("form").validate({
        ...
        messages:{
            username: {
                required: "用户名不能为空，请输入用户名",
                //rangelength:"用户名由3-15个字符组成"
            },
            password: {
                required: "密码不能为空，请输入密码",
                //rangelength:"密码由3-15个字符组成"
            },
            password2: {
                required: "请输入确认密码！和密码一致！",
                //rangelength:"密码由3-15个字符组成",
                equalTo: "两次密码输入不一致"
            },
            email: "请输入正确的邮箱地址",
