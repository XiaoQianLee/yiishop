...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        ...
        <div class="address_bd mt10">
            <h4>修改收货地址</h4>
            <form action="<?=\yii\helpers\Url::to(['member/edit'])?>" name="address_form" method="post">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="addressName" id="addressName" class="txt" value="<?=$model->addressName;?>"/>
                    </li>
                    <li>
                        <label for=""><span>*</span>所在地区：</label>
                        <select id="cmbProvince" name="province" <?=$model->province ? "selected" : ""?>></select>
                        <select id="cmbCity" name="area"></select>
                        <select id="cmbArea" name="town"></select>
                    </li>
                    <li>
                        <label for=""><span>*</span>详细地址：</label>
                        <input type="text" name="detailed_address"  class="txt address" value="<?=$model->detailed_address;?>" />
                    </li>
                    <li>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" name="default" class="check" <?=$model->status = 1 ? "checked" : ""?>/>设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
