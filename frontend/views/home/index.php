    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <?php foreach ($models as $j=>$model):?>
                <div class="cat <?=$j ? '' : 'item1';?>">
                    <h3><a href="<?=\yii\helpers\Url::to(['home/list','id'=>$model->id]);?>"><?=$model->name;?></a><b></b></h3>
                    <div class="cat_detail">
                        <?php foreach ($model->children as $k=>$child):?>
                        <dl <?=$k ? "" : 'class="dl_1st"'?>>
                            <dt><a href="<?=\yii\helpers\Url::to(['home/list','id'=>$child->id])?>"><?=$child->name?></a></dt>
                            <dd>
                                <?php foreach ($child->children as $items):?>
                                <a href="<?=\yii\helpers\Url::to(['home/list','id'=>$items->id])?>"><?=$items->name?></a>
                                <?php endforeach;?>
                            </dd>
                        </dl>
                        <?php endforeach;?>
