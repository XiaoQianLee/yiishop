    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['home/goods','id'=>$model->id])?>"><img src="<?=$model->logo?>" width="160px" height="160px"/></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['home/goods','id'=>$model->id])?>"><?=$model->name?></a></dt>
