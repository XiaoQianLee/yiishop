            ...
            <table class="orders">
                ...
                <tbody>
                   ...
                   <?php foreach ($goods as $good):?>
                       <tr>
                           <td><a href=""><?=$good->order_id;?></a></td>
                           <td><a href=""><img src="<?=$good->logo?>" alt="" /></a></td>
                           <td><?=$good->orders->name?></td>
                           <td>￥<?=$good->total?> <?=$good->orders->payment_name?></td>
                           <td><?=date('Y-m-s H:i:s',$good->orders->create_time)?></td>
                           <td><?php if ($good->orders->status == 0) {
                               echo '已取消';
                               } elseif ($good->orders->status == 1) {
                               echo '待付款';
                               } elseif ($good->orders->status == 2) {
                                   echo '待发货';
                               } elseif ($good->orders->status == 3) {
                                   echo '待收货';
                               } elseif ($good->orders->status == 4) {
                                   echo '完成';
                               }?></td>
