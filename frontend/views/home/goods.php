        ...
        <div class="summary">
            ...
            <div class="preview fl">
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach ($good_gallery as $k=>$v):?>

                                <li class="<?=$k? "" : 'cur';?>">
                                    <a href='<?=$v->path;?>' rel="{gallery: 'gal1', smallimage: '<?=$v->path;?>',largeimage: '<?=$v->path;?>'}"><img src='<?=$v->path;?>'></a>
                                </li>
                            <?php endforeach;?>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li><span>上架时间：</span><?=date('Y-m-s',$model->create_time)?></li>
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>上架时间：</span><?=date('Y-m-s H:i:s',$model->create_time)?></li>
